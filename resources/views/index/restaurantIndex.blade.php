          ...
          <div class="row">
            <div class="col-lg-8">
              ...
              <div class="mb-3">
                ...
                <span class="ms-2 text-muted">(100 Reviews)</span>
              </div>
            </div>
            <hr>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
          ...
          <div class="review-item">
            ...
            <p>"The food was amazing! The service was quick and friendly. Definitely coming back!"</p>
          </div>
          <div class="review-item">
            <p><strong>Jane Smith:</strong> ⭐⭐⭐☆☆</p>
            <p>"The ambiance was great, but the food took a bit too long to arrive."</p>
          </div>
          <div class="review-item">
            <p><strong>Michael Lee:</strong> ⭐⭐⭐⭐⭐</p>
            <p>"An excellent dining experience! The best pasta I've ever had."</p>
          </div>
              ...
              <div class="col-lg-6 d-flex">
                <div class="card" style="height: 150px; border-radius: 20px; width: 100%; background-color: #DECEB0ff; border-color: white">
                  <div class="row">
                      ...
                      <div class="col">
                          <p class="col d-flex justify-content-center align-items-center" style="height: 100%;">{{$appetizerMenu->menuPrice}}</p>
                      </div>
                  </div>                  
              </div>
              </div>
